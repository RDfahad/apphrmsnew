...
class Path {
  ...
  String get customerLogin =>
      '${defaultLiveUrl['baseUrl']}/${defaultLiveUrl['api_route']}/login';

  String get refreshToken =>
      '${defaultLiveUrl['baseUrl']}/${defaultLiveUrl['api_route']}/refresh_token';
  ...
  String get getRequestUrl =>
      '${defaultLiveUrl['baseUrl']}/${defaultLiveUrl['api_route']}/requests/get';
  ...
  String get workingHoursURL =>
      '${defaultLiveUrl['baseUrl']}/${defaultLiveUrl['api_route']}/get_worked_hours';
}
