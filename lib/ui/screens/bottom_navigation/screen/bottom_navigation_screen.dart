                ...
                items: [
                  BottomNavigationBarItem(
                    icon: Container(
                      ...
                      decoration: BoxDecoration(
                          color: selectedTab.bottomNavigationTabState.index == 0 ?  AppColor.primaryColor : Colors.transparent,
                  ...
                  BottomNavigationBarItem(
                    icon: Badge(
                        ...
                        child: Container(
                          ...
                          height: context.getScreenHeight * 0.05,
                          decoration: BoxDecoration(
                              color: selectedTab.bottomNavigationTabState.index == 1 ?  AppColor.primaryColor : Colors.transparent,
                              borderRadius: BorderRadius.circular(8)
                          ),
                  ...
                  BottomNavigationBarItem(
                    icon: Container(
                      ...
                      height: context.getScreenHeight * 0.05,
                      decoration: BoxDecoration(
                          color: selectedTab.bottomNavigationTabState.index == 2 ?  AppColor.primaryColor : Colors.transparent,
                          borderRadius: BorderRadius.circular(8)
                      ),
                  ...
                  BottomNavigationBarItem(
                    ...
                    Container(
                      ...
                      height: context.getScreenHeight * 0.05,
                      decoration: BoxDecoration(
                          color: selectedTab.bottomNavigationTabState.index == 3 ?  AppColor.primaryColor : Colors.transparent,
                          borderRadius: BorderRadius.circular(8)
                      ),
                  ...
                  BottomNavigationBarItem(
                    ...
                    Container(
                      ...
                      height: context.getScreenHeight * 0.05,
                      decoration: BoxDecoration(
                          color: selectedTab.bottomNavigationTabState.index == 4 ?  AppColor.primaryColor : Colors.transparent,
                          borderRadius: BorderRadius.circular(8)
                      ),
