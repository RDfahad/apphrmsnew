                          ...
                          itemBuilder: (context, index){
                            return Container(
                              ...
                              child: AttendenceListCard(
                                          workingHr: Helper.calculateWorkingHours(date: state.attendanceRecords.data?[index].date,startTime: state.attendanceRecords.data?[index].checkInTime,endTime: state.attendanceRecords.data?[index].checkOutTime),
